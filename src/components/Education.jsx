...
const milestones = [
  {
    ...
    description: 'Ukończenie 3-letniego szkolenia specjalizacyjnego z periodontologii zakończone Państwowym Egzaminem Specjalizacyjnym z najwyższym wynikiem w kraju. Nagroda Izby Lekarskiej za wybitne osiągnięcie.',
  },
  {
    year: 'Wykształcenie',
    title: 'Collegium Medicum Uniwersytetu Jagiellońskiego',
    description: 'Ukończenie jednej z najstarszych i najbardziej prestiżowych uczelni medycznych w Polsce, w Krakowie — gdzie narodziło się głębokie zainteresowanie związkiem zdrowia jamy ustnej ze zdrowiem ogólnym.',
  },
  {
    year: 'Nauka',
    title: 'Praca naukowa i dydaktyczna',
    description: 'Aktywna rola asystenta na uczelni — udział w badaniach naukowych, publikacjach oraz kształceniu przyszłych lekarzy dentystów.',
  },
  {
    year: 'Klinika',
    title: 'Periodontologia zachowawcza i chirurgiczna',
    description: 'Kompleksowa praktyka kliniczna obejmująca leczenie zachowawcze, techniki mikrochirurgiczne oraz interdyscyplinarne planowanie leczenia w klinikach regionu Podhala.',
  },
]
          ...
          <div className="space-y-16 lg:space-y-24">
            {milestones.map((item, i) => (
              ...
              >
                ...
                {/* Content */}
                <div className={`pl-12 lg:pl-0 lg:w-1/2 ${i % 2 === 0 ? 'lg:text-right lg:pr-16' : 'lg:pl-16'}`}>
